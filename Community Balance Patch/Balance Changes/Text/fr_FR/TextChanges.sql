...
-- Update for Progrès Screen Texts (a little more serious)
	...
	UPDATE Language_fr_FR
	SET Text = 'The Most Prosperous Civilisations'
	...
	UPDATE Language_fr_FR
	SET Text = 'The Most Dazzling Villes'
...
-- Spy Stuff
	...
	UPDATE Language_fr_FR
	SET Text = 'How did your wretched espions get through my defenses? These may be the last words we speak in peace.'
	...
	UPDATE Language_fr_FR
	SET Text = 'I am willing to overlook your recent espionage activites in my lands if you make a solemn promise that it will not happen agagnent.'
