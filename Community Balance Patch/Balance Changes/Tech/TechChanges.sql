...
UPDATE Technologies SET BombardRange=0, BombardIndirect=0 WHERE Type='TECH_GUNPOWDER';
UPDATE Technologies SET BombardRange=0, BombardIndirect=0 WHERE Type='TECH_DYNAMITE';
