...
int CustomMods::getOption(string sOption, int defValue) {
	if (!m_bInit) {
		...
		MOD_OPT_CACHE(CHOKEPOINT_FORT_SCORE);		MOD_OPT_CACHE(ANY_PANTHEON);
		MOD_OPT_CACHE(NO_TOURISM_CONQUEST);
		MOD_OPT_CACHE(LIBERATE_WITH_TECHS);		MOD_OPT_CACHE(DIPLOMACY_CIV4_FEATURES);
